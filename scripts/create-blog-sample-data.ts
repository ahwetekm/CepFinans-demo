...
async function createSampleBlogData() {
    ...
    const posts = await Promise.all([
      db.post.create({
        data: {
          ...
          content: `
            <h1>Next.js 15 ile Yeni Bir Başlangıç</h1>
            <p>Next.js 15, Vercel tarafından duyurulan en son sürüm olarak karşımıza çıkıyor. Bu yeni sürüm, birçok yenilik ve iyileştirme içeriyor.</p>
            
            <h2>Yenilikler Neler?</h2>
            <p>Next.js 15 ile birlikte gelen önemli yenilikler:</p>
            <ul>
              <li><strong>Turbopack:</strong> Hızlandırılmış geliştirme deneyimi</li>
              <li><strong>App Router İyileştirmeleri:</strong> Daha iyi performans ve kullanım kolaylığı</li>
              <li><strong>Font Optimization:</strong> Otomatik font optimizasyonu</li>
              <li><strong>Image Optimization:</strong> Geliştirilmiş resim optimizasyonu</li>
            </ul>
            
            <h2>Nasıl Kullanılır?</h2>
            <p>Next.js 15 kullanmaya başlamak için:</p>
            <pre><code>npx create-next-app@latest my-app --typescript --tailwind --eslint</code></pre>
            
            <p>Bu komut ile yeni bir Next.js 15 projesi oluşturabilirsiniz.</p>
            
            <blockquote>
              <p>Next.js 15, modern web geliştirmenin geleceğidir.</p>
            </blockquote>
          `,
          status: 'PUBLISHED',
          featured: true,
      ...
      db.post.create({
        data: {
          ...
          content: `
            ...
            <p>TypeScript, JavaScript'e statik tipleme özelliği katan güçlü bir dildir. Bu yazıda TypeScript kullanırken dikkat edilmesi gereken en iyi pratikleri ele alacağız.</p>
            
            <h2>Tip Tanımlamaları</h2>
            <p>TypeScript\'te tip tanımlamaları çok önemlidir:</p>
  ...
  role: 'admin' | 'user';
            ...
            <h2>Generics Kullanımı</h2>
            <p>Generics, yeniden kullanılabilir kod yazmamızı sağlar:</p>
            <pre><code>function createApiResponse&lt;T&gt;(data: T, success: boolean) {
  return {
    data,
    success,
    timestamp: new Date()
      ...
      db.post.create({
        data: {
          ...
          content: `
            <h1>Prisma ile Modern Veritabanı Yönetimi</h1>
            <p>Prisma, modern veritabanı yönetimi için geliştirilmiş bir ORM aracıdır. Bu yazıda Prisma\'nın temel özelliklerini ve kullanımını ele alacağız.</p>
            
            <h2>Prisma Nedir?</h2>
            <p>Prisma, veritabanı erişimi için modern bir araçtır:</p>
            <ul>
              <li>Type-safe veritabanı erişimi</li>
              <li>Otomatik sınıf oluşturma</li>
              <li>Veritabanı migrasyonu</li>
              <li>Query optimizasyonu</li>
            </ul>
            
            <h2>Kurulum</h2>
            <p>Prisma kurulumu oldukça basittir:</p>
            <pre><code>npm install prisma --save-dev
npx prisma init</code></pre>
            
            <h2>Schema Tanımlama</h2>
            <p>Prisma schema dosyasında veritabanı modelinizi tanımlayabilirsiniz:</p>
            <pre><code>model User {
